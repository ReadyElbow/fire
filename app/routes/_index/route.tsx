...
{/* <Accordion.Root className={styles.gettingStartedRoot} type="single">
            <Accordion.Item value="explain">
                <Accordion.Trigger>What is FIRE?</Accordion.Trigger>
                <Accordion.Content>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse facilis odit ipsa odio saepe est itaque totam necessitatibus eaque, quos aut, minima pariatur quibusdam optio veniam accusantium? Numquam, exercitationem consequatur!</p>
                </Accordion.Content>
            </Accordion.Item>
        </Accordion.Root> */}
